...
(* OASIS_START *)
(* DO NOT EDIT (digest: bbd088c4a37653949b10e69ebae1e891) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Fat_format"; "Boot_sector"; "Result"];
                      lib_pack = true;
     ...
     oasis_version = "0.3.0";
     oasis_digest =
       Some "\246\169\136\148\029\238\142R\188\231\237\240\170\249d\229";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
