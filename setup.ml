...
(* OASIS_START *)
(* DO NOT EDIT (digest: d5a39b756c480bea970df19c14d5a3a3) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "fat-filesystem";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "Z\174:Km\209\158\219\001\158\129V\139\234\143\146";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
