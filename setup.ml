...
(* OASIS_START *)
(* DO NOT EDIT (digest: a43fa50c27e776d9ae78ef75bf340112) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                      ...
                      },
                   {
                      ...
                      lib_findlib_name = Some "fat-format";
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Block_device_lwt_unix"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "fat";
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [InternalLibrary "fat"; InternalLibrary "fat_lwt"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\141\1828\251\238=\242\226)\171\207\149Z\ts|";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
