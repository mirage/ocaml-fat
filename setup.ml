...
(* OASIS_START *)
(* DO NOT EDIT (digest: 5506f7aedbb99d0e16619dea50f6999f) *)
(*
...
let setup_t =
  {
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_path = "shell";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "fat"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some ";\135Q\161Z\168\131\251\214\137\128\147\236\199%m";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
